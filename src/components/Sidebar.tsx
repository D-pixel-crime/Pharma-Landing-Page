...
const Sidebar = () => {
  return (
    <div className="w-1/5 flex flex-col pr-5">
      <h1 className="flex items-center gap-4 text-3xl text-[#116A6C] font-bold">
        <div className="Blüten" /> Blüten
      </h1>
      <div className="bg-[#62C3C6]/10 text-[#045A5C] flex-center font-bold mt-14 py-0.5 text-lg">
        Filter
      </div>
      <div className="mt-10 flex flex-col gap-2 border-b-2 border-[#62C3C6]/30 pb-4">
        <p className="text-[#365758] flex-center font-bold text-sm">Preis</p>
      ...
      <div className="mt-16 flex flex-col gap-2 border-b-2 border-[#62C3C6]/30 pb-4">
        <p className="text-[#365758] flex-center font-bold text-sm">
          THC Gehalt
        </p>
        <CustomSlider textSymbol="%" />
      </div>
      ...
      <div className="mt-16 flex flex-col gap-2 border-b-2 border-[#62C3C6]/30 pb-4">
        <p className="text-[#365758] flex-center font-bold text-sm">Genetik</p>
      ...
      <div className="mt-16 flex flex-col gap-6 border-b-2 border-[#62C3C6]/30 pb-4 text-[#365758]">
        <div className="w-full flex text-sm">
          <span className="5/6 w-full flex-center text-[#365758]">Terpene</span>
